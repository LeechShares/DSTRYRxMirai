...
var uptimelink = [`https://${process.env.REPL_SLUG}.${process.env.REPL_OWNER}.repl.co`, "https://bot.reikomods.repl.co"]
...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ UP ] ❯ ") + chalk.hex("#00FF00")(`Deku`)))
monitor.on('down', (res) => console.log(chalk.bold.hex("#FF0000")("[ DOWN ] ❯ ") + chalk.hex("#FF0000")(`Deku ${res.statusMessage}`)))
