...
if (haha.includes("to the moon") || haha.includes("moon")){
  ...
  if (haha.includes("sake") || haha.includes("shake")){
    api.sendMessage("bakit mo ko hinahanap?", event.threadID, event.messageID)
}
...
if (haha.includes("ano?") || haha.includes("ano")){
    ...
    api.sendMessage("langsa ng bibigmo parang puke mo", event.threadID, event.messageID)
}
