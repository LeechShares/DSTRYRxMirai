...
"https://i.imgur.com/aV4WVsq.jpg"
     ...
     var callback = () => api.sendMessage({body:`mas masarap pako jan 👇👇👇`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
