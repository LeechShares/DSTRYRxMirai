...
module.exports.handleEvent = function({ api, event, client, __GLOBAL, Users }) {
	...
	if (event.body.indexOf("hard")==0 || (event.body.indexOf("yard")==0 || (event.body.indexOf("hi hard")==0 || (event.body.indexOf("hello hard")==0)))) {
			api.sendMessage("sanaol kaila kas akoa🙂", event.threadID, (e, info) => {
      setTimeout(() => {
