...
const fs = global.nodemodule["fs-extra"];
  var link = [
    "https://media.tenor.com/D6ZU_ek2UNIAAAAd/cong-tv-prank.gif",
    /*
   ...
   var callback = () => api.sendMessage({body:`Bastos ka dahil jan minus points ka sa langit\n\nbold number ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
