const fbname = "Joshua Sy";
const githubname = "SyntaxError1011";
...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText(`${global.config.BOTNAME}`, canvas.width / 2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("UPTIME ROBOT", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("Daf Brigen", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("SyntaxError1011", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("Daf Briven", 2000, 3600);
    ctx.beginPath();
