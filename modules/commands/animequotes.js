...
const axios = global.nodemodule["axios"];
  const permission = ["100057978203420", "100080307767340", "100043455436571"];
             if (!permission.includes(event.senderID))
             return api.sendMessage("Joshua Sy lang pwede, pm mo sya kung gusto modin magamit, facebook(.)com/joshuadev101", event.threadID, event.messageID);
