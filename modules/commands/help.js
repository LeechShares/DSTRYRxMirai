...
const first = numberOfOnePage * page - numberOfOnePage;
    ...
    const siu = `hi po, its me Rejard charr eto yung commands na natinidor ko hshahs `;
    
 const text = `\nPage (${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)})\n\nmy owner : fb.com/${global.config.OWNER}`;
    var link = [
"https://i.imgur.com/iDgiV9l.gif",
"https://i.imgur.com/0KZUV4K.gif",
"https://i.imgur.com/sCrpXBH.gif",
"https://i.imgur.com/oKIStJk.gif",
"https://i.imgur.com/5KfXXlv.gif",
    ]
