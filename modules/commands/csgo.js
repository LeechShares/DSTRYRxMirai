...
module.exports.handleReply = async function({ api, event, args, handleReply, client, global, Threads, Users, Currencies }) {
    ...
    switch (handleReply.type) {
      ...
      else return api.sendMessage(`𝗦𝗮𝗶 𝗿𝗼̂̀𝗶 𝗸𝗲̂́𝘁 𝗾𝘂𝗮̉ 𝗹𝗮̀ ${handleReply.answer_} 𝗺𝗼̛́𝗶 𝗰𝗵𝗶́𝗻𝗵 𝘅𝗮́𝗰 🍄`}, handleReply.threadID, () => api.unsendMessage(handleReply.messageID));    
